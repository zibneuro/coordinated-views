...
class ViewSpecificationsControl extends React.Component {
    ...
    handleViewOptionChange(event) {        
        this.setState((state, props) => {
            if(event){            
                state.selected_view_add = {value: event.value, label: event.value};            
            } else {
    ...
    handleViewAddClick(event) {        
        ...
        let newView = deepCopy(this.dataManager.available_views.find(view => view.type === this.state.selected_view_add.value));        
                                                ...
                                                <div>
                                                    <table>
                                                        <tbody>
                                                            ...
                                                            <tr>                                                                
                                                                <td colSpan={3}>
                                                                    {formatDatasources(object.dataColumn)}
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
