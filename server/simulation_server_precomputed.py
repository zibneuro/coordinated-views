...
We therefore supply precomputed simulation data for testing the simulation views of the 
visual analysis tool. Please refer to README.md for the download link. 

Usage:
python simulation_server_precomputed.py <simulation_data_precomputed>
"""
...
@app.route("/matrixComputeServer/getSimulation", methods=["GET", "POST"])
@cross_origin()
def getSimulation():
    #global mdb
    #global morphologies
